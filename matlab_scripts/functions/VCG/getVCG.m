...
%GETVCG Calcula el VCG en base a las derivaciones contenidas en la matriz
%ECG, concretamente V1-V6, I, II
% 
% INPUTS:
%     ECG: Matriz con las 12 derivaciones en el orden clásico (I, II, ..., V1, ..., V6)
%     ECG: Matriz con las 8 derivaciones necesarias en el orden (V1-V6, I, II)
%     plot_flag: Opcional (Default false) - Indica si plotear el VCG
%
% OUTPUS: 
%     VCG: Matriz de (NumSamples X 3) con el VectoCardiograma de ECG
% SEE:
%     http://www.mit.edu/~gari/CODE/DOWER/

    % Necesitamos V1-V6, I, II
    [n, m] = size(ECG);
    if n > m
        NumChannels = m;
        if NumChannels == 12
        ...
        elseif NumChannels == 8
            ...
            error('No se puede calcular el VCG sin las derivaciones V1-V6, I, II');
        end            
    else
        NumChannels = n;
        if NumChannels == 12
